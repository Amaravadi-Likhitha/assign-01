...
for j in range(n):
  ...
  d.update({'Roll num':'1801'})
  d.update({'Branch':'CSE'})
  d.update({'Specialization':'CSE'})
  d.update({'Email-Id':'lamarava@gitam.in'})
  d.update({'Replit-Id':'Amaravadi-Likhitha'})
  d.update({'GitHub-Id':'AmaravadiLikhitha'})
  d.update({'Moodle-Id':'VU21CSEN0101801'})
  d.update({'Semester':'2'})
  d.update({'Year':'1'})
  return d
